...
#import <KZ_CategoriesFramework/UIImage+KZ_Bundle.h>
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        UIImageView *playImageView = [[UIImageView alloc] initWithImage:[UIImage kz_imageNamed:@"play" bundleClass:NSClassFromString(@"KZ_VideoPlayer") bundleName:@"KZ_VideoPlayerBundle"]];
